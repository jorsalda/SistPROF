...
def registrar_usuario(email, password, tipo_registro='colegio', nombre_colegio=None,
    ...
    Args:
        tipo_registro: 'colegio' o 'independiente'
        nombre_colegio: Nombre del colegio (solo si tipo_registro='colegio')
        codigo_acceso: Código personalizado (opcional)
        nombre_completo: Nombre del usuario independiente
        rol_independiente: 'docente' o 'estudiante' (solo si tipo_registro='independiente')
    ...
    try:
        ...
        if tipo_registro == 'independiente':
            ...
            # Crear el usuario independiente
            nuevo_usuario = Usuario(
                ...
                is_active=True,
                is_approved=True,  # Los independientes están aprobados automáticamente
                fecha_registro=datetime.utcnow(),
                fecha_expiracion=None,  # Sin expiración
                dias_prueba=0,
                failed_attempts=0
            )
        ...
        # ═══════════════════════════════════════════════════════════
        # CASO 2: REGISTRO DE NUEVO COLEGIO (Comportamiento original)
        # ═══════════════════════════════════════════════════════════
        else:
            # Validar datos requeridos
            ...
            # Generar o usar código de acceso proporcionado
            ...
            # Calcular fecha de expiración (15 días desde hoy)
            ...
            # Mensaje personalizado según si se generó o no el código
            if codigo_generado:
