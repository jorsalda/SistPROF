...
def process_pending_citaciones(app=None):
    """
    ...
    if app:
        with app.app_context():
            _procesar_citaciones_interno()
    else:
        _procesar_citaciones_interno()


def _procesar_citaciones_interno():
    """
    ...
    try:
        ...
        # En lugar de cargar 3 objetos completos (CitacionAcudiente + Acudiente + Estudiante)
        ...
        for idx, citacion in enumerate(pendientes, 1):
            try:
                ...
                <div style="font-family: sans-serif; max-width: 600px; margin: auto;">
                    ...
                    <p>Se le cita para el día <strong>{citacion.fecha_citacion.strftime('%d/%m/%Y')}</strong>.</p>
                    <p><strong>Estudiante:</strong> {citacion.estudiante_nombre}</p>
...
def notify_student_ingress(estudiante_id, hora_ingreso, sede_nombre):
    """
