...
# Blueprints (Importaciones absolutas y únicas)
...
from app.routes.coordinador_routes import coordinador_bp  # ✅ FALTABA ESTA IMPORTACIÓN
...
def create_app():
    ...
    app.register_blueprint(coordinador_bp)  # ✅ AHORA SÍ ESTÁ DEFINIDO
